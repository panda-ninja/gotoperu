...
@section('content')
    ...
    @foreach($paquete as $paquete)
        ...
        <div class="text-center">
            <h2><b class="text-warning">Package Travel: {{$paquete->titulo}}</b></h2>
        ...
        <div>
            <h3 class="no-margin text-warning">Itinerary for days</h3>
            @php
                $precio_iti=0;
            @endphp
            @foreach($paquete->itinerario_cotizaciones->sortBy('dias') as $itinerario)
                ...
                <div class="row">
                    <div class="col-lg-12 text-center centrar-todo">
                        @if (Storage::disk('itinerary')->has($itinerario->imagen))
                            ...
                            <img src="{{route('itinerary_image_path', ['filename' => $itinerario->imagen])}}" alt="" class="responsive-img3" width="215px" height="215px">
                        @endif

                        @if (Storage::disk('itinerary')->has($itinerario->imagenB))
                            {{--<img src="{{route('itinerary_image_path', ['filename' => $itinerario->imagen])}}" width="360" height="360" class="responsive-img" alt="">--}}
                            <img src="{{route('itinerary_image_path', ['filename' => $itinerario->imagenB])}}" alt="" class="responsive-img3" width="215px" height="215px">
                        @endif

                        @if (Storage::disk('itinerary')->has($itinerario->imagenC))
                            {{--<img src="{{route('itinerary_image_path', ['filename' => $itinerario->imagen])}}" width="360" height="360" class="responsive-img" alt="">--}}
                            <img src="{{route('itinerary_image_path', ['filename' => $itinerario->imagenC])}}" alt="" class="responsive-img3" width="215px" height="215px">
                        @endif
                    </div>
                </div>
                {{--<img src="{{asset('img/itinerary/'.str_replace(' ','-',$itinerario->titulo).'')}}.jpg" class="responsive-img" alt="">--}}
                <h4>Servicios:</h4>
                <table class="table table-condensed table-striped table-bordered table-responsive margin-bottom-20">
                <thead>
                <tr>
        ...
        @endphp
        <div>
            <h3 class="text-warning"><b>Destinations:</b></h3>
            @php
                $array_destinos[]=null
            @endphp
        ...
        <div>
            <h3 class="text-warning"><b>Price:</b></h3>
            ...
            @foreach($paquete->paquete_precios as $precio_paquete2)
                ...
                <div>
                    <h5 class="no-margin text-warning"><b>CATEGORY: {{$precio_paquete2->estrellas}} STARS</b></h5>
                    <table class="table table-condensed table-striped table-bordered table-responsive margin-bottom-20">
                        <thead>
                        <tr>
                            <th>Acomodation</th>

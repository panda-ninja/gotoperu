    ...
    <div class="row margin-top-20">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">{{$cliente->nombres}} <small>{{$cliente->email}}</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="{{$cliente->nombres}} esta activo"></i></h1>
                    ...
                    <br><br>
                    <i class="fa fa-tags" aria-hidden="true"></i> <a href="/tags/diaspora" class="tag">#</a> <a href="/tags/hashtag" class="tag">#hashtag</a> <a href="/tags/caturday" class="tag">#caturday</a>
                    <br><br><hr>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <h4><a href="#" style="text-decoration:none;"><strong>Grupo</strong></a> – <small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> {{$cotizaciones->fecha}}</i></a></small></small></h4>

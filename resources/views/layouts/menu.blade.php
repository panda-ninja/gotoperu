@if(auth()->guard('admin')->user()->tipo_user=='admin')
    <li>
        <a class="active @if(session()->get('menu')=='ventas'){{'activo'}}@endif" href="{{route('index_path')}}"><i class="fas fa-angle-right"></i> Ventas</a>
    </li>
    <li>
        <a class="@if(session()->get('menu')=='reservas'){{'activo'}}@endif" href="{{route('book_path')}}"><i class="fas fa-angle-right"></i> Reservas</a>
    </li>
    <li>
        <a class="@if(session()->get('menu')=='contabilidad'){{'activo'}}@endif" href="{{route('contabilidad_index_path')}}"><i class="fas fa-angle-right"></i> Contabilidad</a>
    </li>
    <li>
        <a class="@if(session()->get('menu')=='operaciones'){{'activo'}}@endif" href="{{route('operaciones_path')}}"><i class="fas fa-angle-right"></i> Operaciones</a>
    </li>
    <li>
        <a class="@if(session()->get('menu')=='reportes'){{'activo'}}@endif" href="{{route('reportes_path')}}"><i class="fas fa-angle-right"></i> Reportes</a>
    </li>
